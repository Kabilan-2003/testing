...
class TestFailuresPanel(private val project: Project) : JPanel() {
    ...
    private fun createTestFailuresTable(): TableView<TestFailure> {
        val columns = arrayOf(
            ...
            ErrorMessageColumn(),
            FailureTimeColumn(),
            TestFailureStatusColumn()
        )
        val model = ListTableModel<TestFailure>(columns.toList())
        val table = TableView<TestFailure>(model)
    ...
    private fun createJiraTicketsTable(): TableView<JiraTicket> {
        val columns = arrayOf(
            ...
            JiraTicketStatusColumn(),
            CreatedTimeColumn(),
            PriorityColumn()
        )
        val model = ListTableModel<JiraTicket>(columns.toList())
        val table = TableView<JiraTicket>(model)
    ...
    private inner class TestFailureStatusColumn : ColumnInfo<TestFailure, String>("Status") {
    ...
    private inner class JiraTicketStatusColumn : ColumnInfo<JiraTicket, String>("Status") {
